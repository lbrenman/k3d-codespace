...
kubectl get pod liveness-demo -n lab9 -w
...
kubectl exec -n lab9 $POD1 -- sh -c "echo 'restored' > /usr/share/nginx/html/index.html"
...
kubectl delete deployment readiness-demo -n lab9
kubectl delete service readiness-demo -n lab9
...
kubectl get pod startup-demo -n lab9 -w
...
kubectl describe pod -n lab9 -l app=production-pattern | grep -A8 "Startup\|Liveness\|Readiness"
