...
kubectl get hpa -n lab8
kubectl describe hpa php-apache-hpa -n lab8
...
kubectl run load-generator \
  ...
  --restart=Never \
  -n lab8 \
  -- /bin/sh -c "while true; do wget -q -O- http://php-apache.lab8.svc.cluster.local; done"

# ── Step 6: Watch the autoscaler respond ─────────────────────────────────────
# Back in your main terminal. Takes ~60-90 seconds to start scaling.
kubectl get hpa -n lab8 -w
...
kubectl delete pod load-generator -n lab8
